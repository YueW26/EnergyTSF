...
class StockBlockLayer(nn.Module):
    ...
    def spe_seq_cell(self, input):
        ...
        # Perform FFT using the new FFT API
        ...
        # Reconstruct using the inverse FFT
        complex_input = torch.complex(real, img)
        iffted = torch.fft.ifft(complex_input, dim=-1).real  # Taking the real part if needed
